...
public class NewspaperController {
    ...
    @GetMapping("/add")
    public ResponseEntity<Object> getFromWeb() throws IOException {
        ...
        try {
            ...
            return ResponseHandler.responseSuccessBuilder(
                    true,
                    HttpStatus.CREATED, newspaperService.addListNewspaper(list));
        } catch (Exception e) {
            return ResponseHandler.responseErrorBuilder(false,
